                            ...
                            <div class="">
                                <form action="{{ route('blog.store') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group m-b-20">
                                        ...
                                        <div class="radio radio-info radio-inline">
                                            <input type="radio" id="inlineRadio3" value="2"
                                                   name="type">
                                            <label for="inlineRadio3"> Image </label>
                                        </div>
                                        <div class="radio radio-info radio-inline">
                                            <input type="radio" id="inlineRadio4" value="3"
                                                   name="type">
                                            <label for="inlineRadio4"> Video </label>
                                        </div>
                                        <div class="radio radio-info radio-inline">
                                            <input type="radio" id="inlineRadio5" value="4"
                                                   name="type">
                                            <label for="inlineRadio5"> Audio </label>
                                        </div>
                                    </div>
                                    <div class="form-group m-b-20">
