    ...
    <div class="comment-body comment-body-answered clearfix">
        ...
        <div class="comment-text">
            <div class="author clearfix">
                ...
                <a class="comment-reply" id="reply-button-{{$comment->id}}" ><i class="icon-reply"></i>Reply</a>
            </div>
...
@section('inline_scripts')
    ...
    <script type="text/javascript">
        var commentIds = "<?php echo json_encode($commentIds); ?>";
        console.log(commentIds);
        for (i in commentIds) {
            $("#reply-button-".i).click(function(){
                $(".respond-form-".i).show();
